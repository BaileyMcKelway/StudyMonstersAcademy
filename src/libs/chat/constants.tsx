...
import { openAIKey, openAIOrganization } from '../config';
...
export const subjectMessages = (e: {
  channel?: any;
  author?: any;
  content?: any;
  reply?: any;
...
export const subjectAndIdeasMessages = (text: string) => [
  {
    role: 'system',
    content:
...
export const trueOrFalseMessages = (e: {
...
export const monsterMessagesBeginner = (e: any, messages: any) => [
  {
    role: 'system',
...
export const monsterMessagesIntermediate = (
  e: any,
...
export const monsterMessagesAdvanced = (
  e: any,
  messages: { role: string; content: string }[]
) => [
  {
...
export const monsterMessagesEndGame = (e: any, messages: any) => [
  {
    role: 'system',
...
export const monsterDoesNotKnowMessages = (
  e: any,
  messages: { role: string; content: string }[]
) => [
  {
...
export const monsterDoesNotKnowExcuseMessages = (
  e: any,
  messages: { role: string; content: string }[]
) => [
  {
...
export const essayCreation = (essay: string) => [
  {
    role: 'system',
