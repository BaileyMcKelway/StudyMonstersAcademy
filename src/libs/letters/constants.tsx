export const levelThreeKiwanoLetter = ({ essay, type }) =>
  `
✉️ ✉️ ✉️
*Dear ${type},
...
✉️ ✉️ ✉️
`;
export const levelFiveKiwanoLetter = ({ essay, type }) =>
  `
✉️ ✉️ ✉️
  *Dear ${type},
...
✉️ ✉️ ✉️
`;
export const levelSevenKiwanoLetter = ({ essay, type }) =>
  `
✉️ ✉️ ✉️
  *Dear ${type},
...
✉️ ✉️ ✉️
`;
export const levelNineKiwanoLetter = ({ essay, type }) =>
  `
✉️ ✉️ ✉️
  *Dear ${type},
...
✉️ ✉️ ✉️
`;
export const levelTenKiwanoLetter = ({ type }) =>
  `
✉️ ✉️ ✉️
  *${type}!,
...
export const monsterLetterFollowUpIntro = {
...
export const monsterLetterFollowUpResponse = {
